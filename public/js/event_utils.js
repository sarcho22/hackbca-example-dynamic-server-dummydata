    ...
    if(confirm(`Are you sure you want to delete the event ${event_name} (id ${event_id})? This is PERMANENT and cannot be undone.`)) {
        ...
        .then(response => {
            ...
            if (response.ok) {
                ...
                //What to do next is not widely agreed upon, but some kind of redirect (say, to the events page) seems appropriate?
        ...
        .catch(error => {
            ...
            alert(`ERROR: Network error, failed to delete the event ${event_name} (id ${event_id}).`)
        })
